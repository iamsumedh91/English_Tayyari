...
<div class="panel">
    <div class="panel-body">
        <h3 class="title-hero">
            Add Test Sub-category
        </h3>

         <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" action="postsubcategory" method="POST" id="demo-form" data-parsley-validate="">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-lg btn-primary" type="submit" name="submit">Add Sub-Category</button>
                </div>
            </form>
...
<tr>
    ...
    <td><a href="{{ URL('test/editsubcategory/'.$value->id )}}"><button class="btn btn-info">Edit</button></a>
    <form class="delete" action="{{ URL('test/subcategories', $value->id) }}" method="POST" style="float:left;">
