...
<tr>
    ...
    <td><a href="{{ URL('/test/edittestquestion/'.$value->id )}}"><button class="btn btn-info">Edit</button></a>
    <form class="delete" action="{{ URL('/test/deletetestquestion/'.$value->id) }}" method="POST" style="float:left;">
