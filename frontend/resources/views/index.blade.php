		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-sm-9">
					<p><strong>Daily Tips:</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, doloribus omnis minus temporibus perferendis nesciunt quam repellendus nulla nemo ipsum odit corrupti</p>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="tabs" class="tabs">
						<nav>
							<ul>
								<li><a href="#section-1"><span>Phase Of the Day</span></a></li>
								<li><a href="#section-2"><span>World Of the Day</span></a></li>
							</ul>
						</nav>
						<div class="content">
							<section id="section-1">
								...
								<a href="#" class="btn btn-primary align-right">View All</a>
							</section>
							<section id="section-2">
								<p> Fava bean collard greens dandelion okra wakame tomato Sushi gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts.</p>
								<a href="#" class="btn btn-primary align-right">View All</a>
							</section>
						</div><!-- /content -->
					</div><!-- /tabs -->
