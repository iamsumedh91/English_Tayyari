    ...
    <div class="panel-body">
        <h3 class="title-hero">
         ...
         <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" action="{{url('/postcategory')}}" method="POST" id="demo-form" data-parsley-validate="">
                {{csrf_field()}}
                 ...
                 <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="category" placeholder="Required Field" required class="form-control">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="type" placeholder="Required Field" required class="form-control">
                            </div>
                        </div>
