    ...
    <div class="panel-body">
        ...
        @foreach($data as $value)
         <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" id="demo-form" data-parsley-validate="" method="POST" action="{{ URL('/test/updatecategory/'.$value->id )}}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="cname" placeholder="Required Field" value="{{$value->cname}}" required class="form-control">
                            </div>
                        </div>
