<div id="loading">
    ...
    <div id="mobile-navigation">
        ...
        <a href="#" class="logo-content-small" title="English Tayari"></a>
    </div>
    <div id="header-logo" class="logo-bg">
        <a href="{{url('/dashboard')}}" class="logo-content-big" title="English Tayari">
            English <i>Tayari</i>
            <span>The perfect solution for user interfaces</span>
        </a>
        <a href="{{url('/dashboard')}}" class="logo-content-small" title="English Tayari">
            English <i>Tayari</i>
            <span>The perfect solution for user interfaces</span>
        </a>
