...
@endif 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="example-box-wrapper">
                                ...
                                <?php $content= html_entity_decode($values->content);?>
                                <form class="form-horizontal bordered-row" id="demo-form" data-parsley-validate="" method="POST" action="{{url('updateprivacycontent', $values->id)}}">
                                    {!! csrf_field() !!}
